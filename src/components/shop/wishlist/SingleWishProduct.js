            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  <div
                    onClick={(e) => history.push(`/products/${product._id}`)}
                    className="inline-block px-4 py-2 text-white text-xs md:text-base text-center cursor-pointer hover:opacity-75 bg-orange-700"
                  >
                    View
                  </div>
                </div>
                <div className="absolute top-0 right-0 mx-2 my-2 md:relative">
                  <svg
                    ...
                    className="w-6 h-6 cursor-pointer text-orange-700"
                    fill="currentColor"
                    viewBox="0 0 20 20"
