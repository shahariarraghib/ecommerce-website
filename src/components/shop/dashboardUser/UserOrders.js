  ...
  return (
    <Fragment>
      <tr className="border-b">
        <td className="w-48 hover:bg-orange-200 p-2 flex flex-col space-y-1">
        ...
        <td className="hover:bg-orange-200 p-2 text-center cursor-default">
        ...
        <td className="hover:bg-orange-200 p-2 text-center">
          <span className=" mr-1 text-bold">৳</span>
          {order.amount}
        </td>
        <td className="hover:bg-orange-200 p-2 text-center">{order.phone}</td>
        <td className="hover:bg-orange-200 p-2 text-center">{order.address}</td>
        <td className="hover:bg-orange-200 p-2 text-center">
          {order.transactionId}
        </td>
        <td className="hover:bg-orange-200 p-2 text-center">
    ...
    <Fragment>
      <div className="flex flex-col w-full my-4 md:my-0 md:w-9/12 md:px-8">
        <div className="border">
          <div className="py-4 px-4 text-lg font-semibold">My Orders</div>
          <hr />
