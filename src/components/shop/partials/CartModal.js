        ...
        >
          <div className="overflow-y-auto">
            <div className="border-b border-gray-700 flex justify-between">
              <div className="p-4 text-orange-700 text-lg font-semibold">
                Cart
              </div>
              {/* Cart Modal Close Button */}
              <div className="p-4 text-orange-700">
                <svg
            ...
            <div className="m-4 flex-col">
              {products &&
                ...
                products.map((item, index) => {
                  return (
                    <Fragment key={index}>
                      {/* Cart Product Start */}
                      <div className="text-dark flex space-x-2 my-4 items-center">
                        <img
                        ...
                        <div className="relative w-full flex flex-col">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center justify-between space-x-2">
                              <div className="text-sm text-dark font-weight-bold">
                                Quantity :
                              </div>
                            ...
                            <div>
                              ...
                              <span className=" mr-1 text-2xl text-orange-700">
                                ৳
                              </span>
                          ...
                          <div
                            ...
                            className="absolute top-0 right-0 text-dark"
                          >
                            <svg
              ...
              {products === null && (
                <div className="m-4 flex-col text-dark text-xl text-center">
                  No product in cart
                </div>
              )}
            </div>
            ...
            {data.cartTotalCost ? (
              <Fragment>
                {isAuthenticate() ? (
                  ...
                  >
                    Checkout <span className=" mr-1 text-2xl">৳</span>
                    {data.cartTotalCost - 60}
                  </div>
                ) : (
                  <div
                    className="bg-orange-100 text-black p-4 w-full rounded-full tracking-wide
