    ...
    <Fragment>
      <div className="col-span-1 overflow-auto bg-white shadow-lg p-4">
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              <th className="text-center py-2 border">Product</th>
              ...
              <th className="text-center py-2 border">Stock</th>
              <th className="text-center py-2 border">Category</th>
              <th className="text-center py-2 border">Offer</th>
      ...
      <tr>
        ...
        <td className="p-2 text-center">
          {product.pStatus === "Active" ? (
            <span className="bg-green-200 rounded-full text-xs px-2 font-semibold p-1">
              {product.pStatus}
            </span>
          ) : (
