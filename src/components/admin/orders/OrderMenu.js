      ...
      <div className="col-span-1 flex items-center">
        <div className="flex flex-col space-y-4 md:flex-row md:justify-between md:items-center md:space-y-0 w-full">
          ...
          <div
            ...
            className="relative rounded-full text-gray-100 text-sm font-semibold uppercase bg-orange-700"
          >
            <div
            ...
            <div
              ...
              className={`${
                dropdown ? "" : "hidden"
              } absolute top-0 left-0 mt-12 rounded-lg overflow-hidden w-full md:w-48 flex flex-col z-10 bg-orange-200`}
            >
              <span
                onClick={(e) =>
                  filterOrder("All", data, dispatch, dropdown, setDropdown)
                }
                className="px-4 py-2 text-black hover:bg-orange-700 text-center cursor-pointer hover:text-white"
              >
                All
              </span>
              <span
